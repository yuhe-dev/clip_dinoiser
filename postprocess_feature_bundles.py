...
def process_dimension_records(raw_records: Sequence[Dict[str, object]], dimension_schema: Dict[str, object]) -> List[Dict[str, object]]:
...
def process_dimension_bundle(
    ...
    processed_records = process_dimension_records(raw_records, dimension_schema)
